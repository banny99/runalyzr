...
export const THRESHOLDS: Partial<Record<AllMetricKeys, ThresholdEntry>> = {
  ...
  hipVerticalOscillation: { green: [0,   1.5], amber: [1.5, 3],   unit: ' cm',   direction: 'higher_is_worse' },
  ...
  // Rear
  hipRock:                { green: [0,   2],   amber: [2,   4],   unit: ' cm',   direction: 'higher_is_worse' },
  pelvicObliquity:        { green: [0,   1],   amber: [1,   2],   unit: ' cm',   direction: 'higher_is_worse' },
  kneeVarusValgus:        { green: [0,   1],   amber: [1,   2],   unit: ' cm',   direction: 'higher_is_worse' },
  heelAlignment:          { green: [0,   1],   amber: [1,   2],   unit: ' cm',   direction: 'higher_is_worse' },
  // Front
  kneeSymmetry:           { green: [0,   1],   amber: [1,   2],   unit: ' cm',   direction: 'higher_is_worse' },
  elbowWidthSymmetry:     { green: [0,   1],   amber: [1,   2],   unit: ' cm',   direction: 'higher_is_worse' },
  shoulderLevel:          { green: [0,   1],   amber: [1,   2],   unit: ' cm',   direction: 'higher_is_worse' },
