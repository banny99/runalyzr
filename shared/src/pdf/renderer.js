...
export function generateReport(sections, meta) {
    ...
    if (meta.clientName)
        doc.text(`Client: ${meta.clientName}`, margin + 120, y);
    y += 6;
    // Logo placeholder
    ...
    for (let i = 1; i <= pageCount; i++) {
        ...
        doc.setFontSize(7);
        doc.setTextColor(150, 150, 150);
        doc.text(`Generated by ${meta.appName} — on-device analysis, no data transmitted | Page ${i} of ${pageCount}`, pageWidth / 2, 290, { align: 'center' });
        doc.setTextColor(0, 0, 0);
    }
